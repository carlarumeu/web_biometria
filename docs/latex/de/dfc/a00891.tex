\doxysection{etag}
\hypertarget{a00891}{}\label{a00891}\index{etag@{etag}}
\label{a00891_autotoc_md742}%
\Hypertarget{a00891_autotoc_md742}%
...
This module generates HTTP ETags (as defined in RFC 7232) for use in HTTP responses.\hypertarget{a00891_autotoc_md743}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{a00891_autotoc_md743}
...
\end{DoxyCode}
\hypertarget{a00891_autotoc_md744}{}\doxysubsection{\texorpdfstring{API}{API}}\label{a00891_autotoc_md744}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ \mbox{\hyperlink{a01699_aa7b4b88130584154c4a863b71b8a3075_aa7b4b88130584154c4a863b71b8a3075}{etag}}\ =\ require(\textcolor{stringliteral}{'etag'})}

\end{DoxyCode}
\hypertarget{a00891_autotoc_md745}{}\doxysubsubsection{\texorpdfstring{etag(entity, \mbox{[}options\mbox{]})}{etag(entity, \mbox{[}options\mbox{]})}}\label{a00891_autotoc_md745}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{a00104_abde3c35e3bb7e5225dd7f234c685329c_abde3c35e3bb7e5225dd7f234c685329c}{res}}.setHeader(\textcolor{stringliteral}{'ETag'},\ \mbox{\hyperlink{a01699_aa7b4b88130584154c4a863b71b8a3075_aa7b4b88130584154c4a863b71b8a3075}{etag}}(body))}

\end{DoxyCode}
\hypertarget{a00891_autotoc_md746}{}\doxysubsubsubsection{\texorpdfstring{Options}{Options}}\label{a00891_autotoc_md746}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{a00891_autotoc_md747}{}\doxysubsubsubsubsection{\texorpdfstring{weak}{weak}}\label{a00891_autotoc_md747}
Specifies if the generated ETag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{a00891_autotoc_md748}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{a00891_autotoc_md748}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{a00891_autotoc_md749}{}\doxysubsection{\texorpdfstring{Benchmark}{Benchmark}}\label{a00891_autotoc_md749}
...
\end{DoxyCode}
\hypertarget{a00891_autotoc_md750}{}\doxysubsection{\texorpdfstring{License}{License}}\label{a00891_autotoc_md750}
