...
Also, see the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting Buffer}} guide.\hypertarget{a00966_autotoc_md2149}{}\doxysubsection{\texorpdfstring{Do I need it?}{Do I need it?}}\label{a00966_autotoc_md2149}
...
See the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting guide}} for a better description.\hypertarget{a00966_autotoc_md2150}{}\doxysubsection{\texorpdfstring{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}}\label{a00966_autotoc_md2150}
...
Also, {\ttfamily safer-\/buffer} discourages the usage of {\ttfamily .alloc\+Unsafe()}, which is often done by a mistake. It still supports it with an explicit concern barier, by placing it under `require(\textquotesingle{}safer-\/buffer/dangereous')\`{}.\hypertarget{a00966_autotoc_md2151}{}\doxysubsection{\texorpdfstring{But isn\textquotesingle{}t throwing bad?}{But isn\textquotesingle{}t throwing bad?}}\label{a00966_autotoc_md2151}
...
New commits, if tested, won\textquotesingle{}t land new usage of unsafe Buffer API this way. {\itshape Node.\+js 10.\+x also deals with that by printing a runtime depecation warning.}\hypertarget{a00966_autotoc_md2152}{}\doxysubsubsection{\texorpdfstring{Would it affect third-\/party modules?}{Would it affect third-\/party modules?}}\label{a00966_autotoc_md2152}
No, unless you explicitly do an awful thing like monkey-\/patching or overriding the built-\/in {\ttfamily Buffer}. Don\textquotesingle{}t do that.\hypertarget{a00966_autotoc_md2153}{}\doxysubsubsection{\texorpdfstring{But I don\textquotesingle{}t want throwing…}{But I don\textquotesingle{}t want throwing…}}\label{a00966_autotoc_md2153}
That is also fine!
...
Note that using a linter to catch accidential {\ttfamily Buffer} constructor usage in this case is strongly recommended. {\ttfamily Buffer} is not overriden in this usecase, so linters won\textquotesingle{}t get confused.\hypertarget{a00966_autotoc_md2154}{}\doxysubsection{\texorpdfstring{«\+Without footguns»?}{«\+Without footguns»?}}\label{a00966_autotoc_md2154}
