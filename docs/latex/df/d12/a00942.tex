\doxysection{iconv-\/lite\+: Pure JS character encoding conversion}
\hypertarget{a00942}{}\label{a00942}\index{iconv-\/lite: Pure JS character encoding conversion@{iconv-\/lite: Pure JS character encoding conversion}}
\label{a00942_autotoc_md1687}%
\Hypertarget{a00942_autotoc_md1687}%
...
\href{https://npmjs.org/package/iconv-lite/}{\texttt{ }} ~\newline
 \href{https://travis-ci.org/ashtuchkin/iconv-lite}{\texttt{ }} \href{https://npmjs.org/package/iconv-lite/}{\texttt{ }} \href{https://npmjs.org/package/iconv-lite/}{\texttt{ }} \href{https://npmjs.org/package/iconv-lite/}{\texttt{ }}\hypertarget{a00942_autotoc_md1688}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{a00942_autotoc_md1688}
\hypertarget{a00942_autotoc_md1689}{}\doxysubsubsection{\texorpdfstring{Basic API}{Basic API}}\label{a00942_autotoc_md1689}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Convert\ from\ an\ encoded\ buffer\ to\ a\ js\ string.}}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{//\ Convert\ from\ a\ js\ string\ to\ an\ encoded\ buffer.}}
...
\end{DoxyCode}
\hypertarget{a00942_autotoc_md1690}{}\doxysubsubsection{\texorpdfstring{Streaming API}{Streaming API}}\label{a00942_autotoc_md1690}

\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{comment}{//\ Decode\ stream\ (from\ binary\ data\ stream\ to\ js\ strings)}}
...
\end{DoxyCode}
\hypertarget{a00942_autotoc_md1691}{}\doxysubsection{\texorpdfstring{Supported encodings}{Supported encodings}}\label{a00942_autotoc_md1691}
...
\end{DoxyVerb}
\hypertarget{a00942_autotoc_md1693}{}\doxysubsection{\texorpdfstring{BOM handling}{BOM handling}}\label{a00942_autotoc_md1693}
...
\end{DoxyItemize}\hypertarget{a00942_autotoc_md1694}{}\doxysubsection{\texorpdfstring{UTF-\/16 Encodings}{UTF-\/16 Encodings}}\label{a00942_autotoc_md1694}
...
\end{DoxyItemize}\hypertarget{a00942_autotoc_md1695}{}\doxysubsection{\texorpdfstring{UTF-\/32 Encodings}{UTF-\/32 Encodings}}\label{a00942_autotoc_md1695}
...
\end{DoxyItemize}\hypertarget{a00942_autotoc_md1696}{}\doxysubsection{\texorpdfstring{Other notes}{Other notes}}\label{a00942_autotoc_md1696}
...
\hypertarget{a00942_autotoc_md1697}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{a00942_autotoc_md1697}
