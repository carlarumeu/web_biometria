\doxysection{http-\/errors}
\hypertarget{a00917}{}\label{a00917}\index{http-\/errors@{http-\/errors}}
\label{a00917_autotoc_md1263}%
\Hypertarget{a00917_autotoc_md1263}%
...
Create HTTP errors for Express, Koa, Connect, etc. with ease.\hypertarget{a00917_autotoc_md1264}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{a00917_autotoc_md1264}
...
\end{DoxyCode}
\hypertarget{a00917_autotoc_md1265}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{a00917_autotoc_md1265}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ \mbox{\hyperlink{a00116_a36d4507fc5974c25545c80a464e96cff_a36d4507fc5974c25545c80a464e96cff}{createError}}\ =\ require(\textcolor{stringliteral}{'http-\/errors'})}
...
\DoxyCodeLine{\ \ \textcolor{keywordflow}{if}\ (!\mbox{\hyperlink{a00104_a42c43c76081a7df8ae2954f16ee9338b_a42c43c76081a7df8ae2954f16ee9338b}{req}}.user)\ \textcolor{keywordflow}{return}\ next(\mbox{\hyperlink{a00116_a36d4507fc5974c25545c80a464e96cff_a36d4507fc5974c25545c80a464e96cff}{createError}}(401,\ \textcolor{stringliteral}{'Please\ login\ to\ view\ this\ page.'}))}
\DoxyCodeLine{\ \ next()}
\DoxyCodeLine{\})}

\end{DoxyCode}
\hypertarget{a00917_autotoc_md1266}{}\doxysubsection{\texorpdfstring{API}{API}}\label{a00917_autotoc_md1266}
This is the current API, currently extracted from Koa and subject to change.\hypertarget{a00917_autotoc_md1267}{}\doxysubsubsection{\texorpdfstring{Error Properties}{Error Properties}}\label{a00917_autotoc_md1267}
...
\end{DoxyItemize}\hypertarget{a00917_autotoc_md1268}{}\doxysubsubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}}\label{a00917_autotoc_md1268}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{var\ err\ =\ \mbox{\hyperlink{a00116_a36d4507fc5974c25545c80a464e96cff_a36d4507fc5974c25545c80a464e96cff}{createError}}(404,\ \textcolor{stringliteral}{'This\ video\ does\ not\ exist!'})}
...
\end{DoxyItemize}\hypertarget{a00917_autotoc_md1269}{}\doxysubsubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}}\label{a00917_autotoc_md1269}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{a00128_aebcdd70130f7e0b00b39cc981ab0bab0_aebcdd70130f7e0b00b39cc981ab0bab0}{fs}}.readFile(\textcolor{stringliteral}{'foo.txt'},\ \textcolor{keyword}{function}\ (err,\ buf)\ \{}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{if}\ (err)\ \{}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{if}\ (err.code\ ===\ \textcolor{stringliteral}{'ENOENT'})\ \{}
\DoxyCodeLine{\ \ \ \ \ \ var\ httpError\ =\ \mbox{\hyperlink{a00116_a36d4507fc5974c25545c80a464e96cff_a36d4507fc5974c25545c80a464e96cff}{createError}}(404,\ err,\ \{\ expose:\ \textcolor{keyword}{false}\ \})}
\DoxyCodeLine{\ \ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{\ \ \ \ \ \ var\ httpError\ =\ \mbox{\hyperlink{a00116_a36d4507fc5974c25545c80a464e96cff_a36d4507fc5974c25545c80a464e96cff}{createError}}(500,\ err)}
\DoxyCodeLine{\ \ \ \ \}}
\DoxyCodeLine{\ \ \}}
\DoxyCodeLine{\})}
...
\item {\ttfamily properties} -\/ custom properties to attach to the object
\end{DoxyItemize}\hypertarget{a00917_autotoc_md1270}{}\doxysubsubsection{\texorpdfstring{create\+Error.\+is\+Http\+Error(val)}{create\+Error.\+is\+Http\+Error(val)}}\label{a00917_autotoc_md1270}
Determine if the provided {\ttfamily val} is an {\ttfamily Http\+Error}. This will return {\ttfamily true} if the error inherits from the {\ttfamily Http\+Error} constructor of this module or matches the "{}duck type"{} for an error this module creates. All outputs from the {\ttfamily create\+Error} factory will return {\ttfamily true} for this function, including if an non-\/{\ttfamily Http\+Error} was passed into the factory.\hypertarget{a00917_autotoc_md1271}{}\doxysubsubsection{\texorpdfstring{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}}\label{a00917_autotoc_md1271}
Create a new error object with the given message {\ttfamily msg}. The error object inherits from {\ttfamily create\+Error.\+Http\+Error}.


\begin{DoxyCode}{0}
\DoxyCodeLine{var\ err\ =\ \textcolor{keyword}{new}\ \mbox{\hyperlink{a00116_a36d4507fc5974c25545c80a464e96cff_a36d4507fc5974c25545c80a464e96cff}{createError}}.NotFound()}
...
\end{DoxyItemize}\hypertarget{a00917_autotoc_md1272}{}\doxysubsubsubsection{\texorpdfstring{List of all constructors}{List of all constructors}}\label{a00917_autotoc_md1272}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{a00917_autotoc_md1273}{}\doxysubsection{\texorpdfstring{License}{License}}\label{a00917_autotoc_md1273}
