\doxysection{Porting to the Buffer.\+from/\+Buffer.alloc API}
\hypertarget{a00965}{}\label{a00965}\index{Porting to the Buffer.from/Buffer.alloc API@{Porting to the Buffer.from/Buffer.alloc API}}
\label{a00965_autotoc_md2132}%
\Hypertarget{a00965_autotoc_md2132}%


\label{_overview}%
 \hypertarget{a00965_autotoc_md2133}{}\doxysubsection{\texorpdfstring{Overview}{Overview}}\label{a00965_autotoc_md2133}
...
\end{DoxyItemize}\hypertarget{a00965_autotoc_md2134}{}\doxysubsubsection{\texorpdfstring{Finding problematic bits of code using grep}{Finding problematic bits of code using grep}}\label{a00965_autotoc_md2134}
...
It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{a00965_autotoc_md2135}{}\doxysubsubsection{\texorpdfstring{Finding problematic bits of code using Node.\+js 8}{Finding problematic bits of code using Node.\+js 8}}\label{a00965_autotoc_md2135}
...
\end{DoxyCode}
\hypertarget{a00965_autotoc_md2136}{}\doxysubsubsection{\texorpdfstring{Finding problematic bits of code using linters}{Finding problematic bits of code using linters}}\label{a00965_autotoc_md2136}
...
\label{_variant-1}%
 \hypertarget{a00965_autotoc_md2137}{}\doxysubsection{\texorpdfstring{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}}\label{a00965_autotoc_md2137}
...
\label{_variant-2}%
 \hypertarget{a00965_autotoc_md2138}{}\doxysubsection{\texorpdfstring{Variant 2\+: Use a polyfill}{Variant 2\+: Use a polyfill}}\label{a00965_autotoc_md2138}
...
\label{_variant-3}%
 \hypertarget{a00965_autotoc_md2139}{}\doxysubsection{\texorpdfstring{Variant 3 — manual detection, with safeguards}{Variant 3 — manual detection, with safeguards}}\label{a00965_autotoc_md2139}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{a00965_autotoc_md2140}{}\doxysubsubsection{\texorpdfstring{Buffer(0)}{Buffer(0)}}\label{a00965_autotoc_md2140}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{a00965_autotoc_md2141}{}\doxysubsubsection{\texorpdfstring{Buffer(not\+Number)}{Buffer(not\+Number)}}\label{a00965_autotoc_md2141}
Before\+:


\begin{DoxyCode}{0}
\DoxyCodeLine{var\ buf\ =\ \textcolor{keyword}{new}\ Buffer(notNumber,\ \mbox{\hyperlink{a01288_a9ad8213a7626ee07aef47950752cac18_a9ad8213a7626ee07aef47950752cac18}{encoding}});}
...
\DoxyCodeLine{\ \ buf\ =\ Buffer.from(notNumber,\ \mbox{\hyperlink{a01288_a9ad8213a7626ee07aef47950752cac18_a9ad8213a7626ee07aef47950752cac18}{encoding}});}
\DoxyCodeLine{\}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{\ \ \textcolor{keywordflow}{if}\ (typeof\ notNumber\ ===\ \textcolor{stringliteral}{'number'})}
\DoxyCodeLine{\ \ \ \ \textcolor{keywordflow}{throw}\ \textcolor{keyword}{new}\ \mbox{\hyperlink{a01276_ab90d95850f9ba1903a6704f6fa8eccb6_ab90d95850f9ba1903a6704f6fa8eccb6}{Error}}(\textcolor{stringliteral}{'The\ "{}size"{}\ argument\ must\ be\ of\ type\ number.'});}
\DoxyCodeLine{\ \ buf\ =\ \textcolor{keyword}{new}\ Buffer(notNumber,\ \mbox{\hyperlink{a01288_a9ad8213a7626ee07aef47950752cac18_a9ad8213a7626ee07aef47950752cac18}{encoding}});}
\DoxyCodeLine{\}}
...
\end{DoxyCode}
\hypertarget{a00965_autotoc_md2143}{}\doxysubsection{\texorpdfstring{Regarding Buffer.\+alloc\+Unsafe}{Regarding Buffer.\+alloc\+Unsafe}}\label{a00965_autotoc_md2143}
...
\label{_faq}%
 \hypertarget{a00965_autotoc_md2144}{}\doxysubsection{\texorpdfstring{FAQ}{FAQ}}\label{a00965_autotoc_md2144}
\label{_design-flaws}%
 \hypertarget{a00965_autotoc_md2145}{}\doxysubsubsection{\texorpdfstring{What is wrong with the {\ttfamily Buffer} constructor?}{What is wrong with the {\ttfamily Buffer} constructor?}}\label{a00965_autotoc_md2145}
...
\item `new Buffer(\textquotesingle{}abc'){\ttfamily creates a}Buffer{\ttfamily that contains the UTF-\/8-\/encoded version of the string}\textquotesingle{}abc\textquotesingle{}{\ttfamily . \doxylink{a00844}{A} second argument could specify another encoding\+: For example, }new Buffer(string, \textquotesingle{}base64\textquotesingle{})\`{} could be used to convert a Base64 string into the original sequence of bytes that it represents.
...
\label{_ecosystem-usage}%
 \hypertarget{a00965_autotoc_md2146}{}\doxysubsubsection{\texorpdfstring{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}}\label{a00965_autotoc_md2146}
